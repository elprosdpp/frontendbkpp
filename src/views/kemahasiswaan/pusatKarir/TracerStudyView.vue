<template>
  ...
  <div class="">
    ...
    <p class="text-link text-justify">
      ...
      itu mohon kesediaannya bagi para alumni Universitas Ngudi Waluyo meluangkan waktunya
      untuk mengisi kuesioner Tracer Study. Kuesioner ini diperuntukkan bagi alumni
