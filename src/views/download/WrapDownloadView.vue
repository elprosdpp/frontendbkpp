<template>
  <div class="">
    <!-- Panel Header -->
    <PanelHeader judul="Download" caption="Memuat Semua Menu Download" />
...
export default {
  ...
  watch: {
    $route: {
      immediate: true,
      handler(to, from) {
        document.title = to.meta.title || "BKAPP UNW";
      },
    },
  },
};
